  ...
  return (
    <div className='relative h-screen md:min-h-[90vh] pt-24 '>
      ...
      <div className='relative z-30 grid grid-cols-1 lg:grid-cols-12 '>
        <div className="col-span-1 lg:col-span-8 py-20 px-6 lg:py-32 lg:px-12">
          <div className="flex pb-8 leading-relaxed flex-col w-full  item-center justify-center gap-3 text-zinc-100">
            ...
            <h3 className="text-3xl lg:text-5xl bg-gradient-to-tr tracking-wide lg:tracking-widest from-red-600 to-orange-500 bg-clip-text text-transparent font-extrabold uppercase">inspiring partner</h3>
